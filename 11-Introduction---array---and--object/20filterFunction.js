 ...
 * filter should always return a boolean, otherwise output will be converted to a boolean 
    ...
    Filter loops over every element, passes in the argument function and then if the output of the this function call is true, then it stores the original element in a new array otherwise doesn't add this add element to the array
*/
